...
fn integration_test_search_and_avg_score(){
    ...
    let object_terms: HashSet<TermID> = HashSet::from(["GO:0031965".to_string(), "GO:0005773".to_string()]);
    ...
    let entity1: HashSet<TermID> = HashSet::from(["GO:0031090".to_string(), "GO:0005634".to_string(), "GO:0005635".to_string()]);
